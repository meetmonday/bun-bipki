...
if (!query && !showAll) {
	...
	console.error("  --list           List every method with a one-line summary");
	console.error("  --search <term>  Search in method names and descriptions");
	console.error();
...
if (searchMode) {
	...
	if (matches.length === 0) {
		...
		const partial =
			byName.length > 0
				? byName
				: methods.filter((m) => m.description.toLowerCase().includes(q));
		if (partial.length === 1) {
